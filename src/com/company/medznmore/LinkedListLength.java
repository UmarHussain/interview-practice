...
// otherwise, the successor of a node located at index K is located at index A[K] (you can assume
// that A[K] is a valid index, that is 0 ≤ A[K] < N).
...
//
// that, given a non-empty array A consisting of N integers, returns the length of the list
// constructed from A in the above manner.
//
...
class LinkedListLengthSolution{
...
public class LinkedListLength {
  public static void main(String[] args) {
      LinkedListLengthSolution l = new LinkedListLengthSolution();
      int A[] = {1,4,-1,3,2};
